...
public class BookmarkFragmentDirections private constructor() {
  private data class ActionBookmarkFragmentToArticleFragment(
    public val article: Article
  ) : NavDirections {
    public override fun getActionId(): Int = R.id.action_bookmarkFragment_to_articleFragment
  ...
  public companion object {
    public fun actionBookmarkFragmentToArticleFragment(article: Article): NavDirections =
        ActionBookmarkFragmentToArticleFragment(article)
  }
}
