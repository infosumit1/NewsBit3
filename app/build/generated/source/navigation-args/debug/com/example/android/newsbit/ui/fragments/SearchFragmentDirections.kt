...
public class SearchFragmentDirections private constructor() {
  private data class ActionSearchFragmentToArticleFragment(
    public val article: Article
  ) : NavDirections {
    public override fun getActionId(): Int = R.id.action_searchFragment_to_articleFragment
  ...
  public companion object {
    public fun actionSearchFragmentToArticleFragment(article: Article): NavDirections =
        ActionSearchFragmentToArticleFragment(article)
  }
}
